		                	...
		                	<div class="col-md-4">
	                            ...
	                            <div class="row">
	                                ...
	                                <div class="col-md-12 form-group">
	                                    ...
	                                    <select name="payment_method" class="form-control select2" id="advFieldsStatus" onchange="showPaymentForm(this.value)">
                                    ...
                                    <form action="payment/cod/init.php" method="post" id="cod_form" style="display: none;">
                                        ...
                                        <div class="col-md-12 form-group">
                                            <p>You will pay the amount when you receive the product.</p>
